...
public partial interface IDataStorageBroker
{
    ...
    ValueTask<TEntity?> SelectByIdAsync<TEntity>(Guid id, CancellationToken cancellationToken = default) where TEntity : class, IEntity;
    ...
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Entity if found, otherwise null</returns>
    ValueTask<bool> CheckByIdAsync<TEntity>(Guid id, CancellationToken cancellationToken = default) where TEntity : class, IEntity;
